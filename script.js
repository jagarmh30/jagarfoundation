document.addEventListener('DOMContentLoaded', function () {
  ...
  const quantityInput = document.getElementById('waste'); // Changed from wasteInput to quantityInput
  ...
  quantityInput.addEventListener('input', function () { // Changed from wasteInput to quantityInput
  ...
  function loadTotalsData() {
    ...
    fetch(DONORS_SHEET_URL)
      ...
      .then(data => {
        ...
        const quantityValues = data.map(row => ({ // Changed from wasteValues to quantityValues
        ...
        const totalQuantityAmount = quantityValues.reduce((sum, item) => sum + item.waste, 0); // Changed from totalWasteAmount to totalQuantityAmount
  ...
  form.addEventListener('submit', function (e) {
    ...
    const quantityVal = quantityInput.value; // Changed from wasteVal to quantityVal
